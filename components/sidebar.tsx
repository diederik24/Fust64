...
import { LayoutDashboard, PlusCircle, List, Package } from 'lucide-react';
...
export function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-64 bg-gradient-to-b from-blue-600 to-blue-700 text-white shadow-lg z-40">
